// @(#)root/tmva $Id: TMVAClassification_H.C 38895 2011-04-18 11:59:54Z evt $
/**********************************************************************************
 * Project   : TMVA - a ROOT-integrated toolkit for multivariate data analysis    *
 * Package   : TMVA                                                               *
 * Root Macro: TMVAClassification_H                                                 *
 *                                                                                *
 ...
 *                                                                                *
 *    root -l ./TMVAClassification_H.C\(\"Fisher,Likelihood\"\)                     *
 *                                                                                *
...
void TMVAClassification_H( TString myMethodList = "" )
{
   ...
   //
   // mylinux~> root -l TMVAClassification_H.C\(\"myMethod1,myMethod2,myMethod3\"\)
   //
   // if you like to use a method via the plugin mechanism, we recommend using
   //
   // mylinux~> root -l TMVAClassification_H.C\(\"P_myMethod\"\)
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassification_H" << std::endl;
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_H", outputFile,
   ...
   // For an example of the category classifier usage, see: TMVAClassification_HCategory
   ...
   std::cout << "==> TMVAClassification_H is done!" << std::endl;
