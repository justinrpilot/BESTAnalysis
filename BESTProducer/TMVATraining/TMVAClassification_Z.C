// @(#)root/tmva $Id: TMVAClassification_Z.C 38895 2011-04-18 11:59:54Z evt $
/**********************************************************************************
 * Project   : TMVA - a ROOT-integrated toolkit for multivariate data analysis    *
 * Package   : TMVA                                                               *
 * Root Macro: TMVAClassification_Z                                                 *
 *                                                                                *
 ...
 *                                                                                *
 *    root -l ./TMVAClassification_Z.C\(\"Fisher,Likelihood\"\)                     *
 *                                                                                *
...
void TMVAClassification_Z( TString myMethodList = "" )
{
   ...
   //
   // mylinux~> root -l TMVAClassification_Z.C\(\"myMethod1,myMethod2,myMethod3\"\)
   //
   // if you like to use a method via the plugin mechanism, we recommend using
   //
   // mylinux~> root -l TMVAClassification_Z.C\(\"P_myMethod\"\)
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassification_Z" << std::endl;
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_Z", outputFile,
   ...
   // For an example of the category classifier usage, see: TMVAClassification_ZCategory
   ...
   std::cout << "==> TMVAClassification_Z is done!" << std::endl;
