// @(#)root/tmva $Id: TMVAClassification_W.C 38895 2011-04-18 11:59:54Z evt $
/**********************************************************************************
 * Project   : TMVA - a ROOT-integrated toolkit for multivariate data analysis    *
 * Package   : TMVA                                                               *
 * Root Macro: TMVAClassification_W                                                 *
 *                                                                                *
 ...
 *                                                                                *
 *    root -l ./TMVAClassification_W.C\(\"Fisher,Likelihood\"\)                     *
 *                                                                                *
...
void TMVAClassification_j( TString myMethodList = "" )
{
   ...
   //
   // mylinux~> root -l TMVAClassification_W.C\(\"myMethod1,myMethod2,myMethod3\"\)
   //
   // if you like to use a method via the plugin mechanism, we recommend using
   //
   // mylinux~> root -l TMVAClassification_W.C\(\"P_myMethod\"\)
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassification_j" << std::endl;
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_j", outputFile,
   ...
   inputS->AddFile("../test/out_QCDall.root");
   inputB->AddFile("../test/out_TTall.root");
   inputB->AddFile("../test/out_WWall.root");
   inputB->AddFile("../test/out_ZZall.root");
   inputB->AddFile("../test/out_HHall.root");
   ...
   // For an example of the category classifier usage, see: TMVAClassification_WCategory
   ...
   std::cout << "==> TMVAClassification_j is done!" << std::endl;
