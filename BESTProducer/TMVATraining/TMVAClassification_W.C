...
void TMVAClassification_W( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start TMVAClassification_W" << std::endl;
   ...
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_W", outputFile,
   ...
   inputB->AddFile("../test/out_QCDall.root");
   ...
   std::cout << "==> TMVAClassification_W is done!" << std::endl;
