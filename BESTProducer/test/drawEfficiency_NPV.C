...
TFile *combFile = new TFile("out_QCDall_noReduce.root");
...
TH1F *denom2 = new TH1F("denom2", "denom2", 50,0,50);
TH1F *denom3 = new TH1F("denom3", "denom3", 50,0,50);
TH1F *denom4 = new TH1F("denom4", "denom4", 50,0,50);
TH1F *denomC = new TH1F("denomC", "denomC", 50,0,50);
TH1F *num2 = new TH1F("num2", "num2", 50,0,50);
TH1F *num3 = new TH1F("num3", "num3", 50,0,50);
TH1F *num4 = new TH1F("num4", "num4", 50,0,50);
TH1F *numC = new TH1F("numC", "numC", 50,0,50);
...
zp2Tree->Draw("npv >> denom2", "(et > 500 && bDisc > -1)");
zp3Tree->Draw("npv >> denom3", "(et > 500 && bDisc > -1)");
zp4Tree->Draw("npv >> denom4", "(et > 500 && bDisc > -1)");
combTree->Draw("npv >> denomC", "(et > 500 && bDisc > -1)");
zp2Tree->Draw("npv >> num2  ", Form("(et > 500 && bDisc > -1 && %s)", thiscut.c_str()) );
zp3Tree->Draw("npv >> num3  ", Form("(et > 500 && bDisc > -1 && %s)", thiscut.c_str()) );
zp4Tree->Draw("npv >> num4 ", Form("(et > 500 && bDisc > -1 && %s)", thiscut.c_str()) );
combTree->Draw("npv >> numC ", Form("(et > 500 && bDisc > -1 && %s)", thiscut.c_str()) );
...
eff4H->GetXaxis()->SetTitle("Pileup Vertices");
